...
*/
        for(int i = 0; i < whiteSize; i++)
        {
            if((white[i] == 2)&&(board[6] == 0)&&(board[10] == 2))
            {
                cout << 11 << endl;
                solution = 1;
            }
            if((white[i] == 2)&&(board[8] == 0)&&(board[14] == 2))
            {
                cout << 15 << endl;
                solution = 1;
            }
            if((white[i] == 6)&&(board[2] == 0)&&(board[10] == 2))
            {
                cout << 11 << endl;
                solution = 1;
            }
            if((white[i] == 6)&&(board[2] == 2)&&(board[10] == 0))
            {
                cout << 3 << endl;
                solution = 1;
            }
            if((white[i]==10)&&(board[6]==0)&&(board[2]==2))
            {
                cout << 3 << endl;
                solution = 1;
            }
            if((white[i]==10)&&(board[16]==0)&&(board[22]==2))
            {
                cout << 23 << endl;
                solution = 1;
            }
            if((white[i]==16)&&(board[10]==0)&&(board[22]==2))
            {
                cout << 23 << endl;
                solution = 1;
            }
            if((white[i]==16)&&(board[10]==2)&&(board[22]==0))
            {
                cout << 11 << endl;
                solution = 1;
            }
            if((white[i]==22)&&(board[16]==0)&&(board[10]==2))
            {
                cout << 11 << endl;
                solution = 1;
            }
            if((white[i]==22)&&(board[18]==0)&&(board[14]==2))
            {
                cout << 15 << endl;
                solution = 1;
            }
            if((white[i]==18)&&(board[22]==0)&&(board[14]==2))
            {
                cout << 15 << endl;
                solution = 1;
            }
            if((white[i]==18)&&(board[22]==2)&&(board[14]==0))
            {
                cout << 23 << endl;
                solution = 1;
            }
            if((white[i]==14)&&(board[8]==0)&&(board[2]==2))
            {
                cout << 3 << endl;
                solution = 1;
            }
            if((white[i]==14)&&(board[18]==0)&&(board[22]==2))
            {
                cout << 23 << endl;
                solution = 1;
            }
            if((white[i]==8)&&(board[2]==0)&&(board[14]==2))
            {
                cout << 15 << endl;
                solution = 1;
            }
            if((white[i]==8)&&(board[2]==2)&&(board[14]==0))
            {
                cout << 3 << endl;
                solution = 1;
            }
